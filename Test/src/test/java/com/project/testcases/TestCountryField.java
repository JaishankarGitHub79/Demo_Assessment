...
public class TestCountryField {
	...
	public void checkCountry(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		createAccPage.selectEmptyCountry(data.get("cindex"));
		createAccPage.enterMobileNumber(data.get("cell"));
		createAccPage.clickRegisterBtn();
		createAccPage.validateEmptyCountry("There are 3 errors");
	}
