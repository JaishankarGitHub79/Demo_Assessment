...
public class PropertyReader {
	...
	public static String ReadProperty(String PropertyName) throws IOException {
		...
		inputStream = new FileInputStream(ProjectPath + "/src/test/java/com/project/config/config.properties");
		prop = new Properties();
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(PropertyReader.ReadProperty("firefoxdriverpath"));
	}
}
